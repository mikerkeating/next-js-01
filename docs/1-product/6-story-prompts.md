# Story Details Prompts

This document contains prompts for generating story details files for all stories across the platform epics. Each prompt follows the standard template from `docs/3-references/story-details-prompt-template.md`.

-

## Epic 1A.1: Monorepo Foundation

### 1A.1.S1 - Install and configure Turborepo - DONE
...
### 1A.1.S2 - Create monorepo directory structure - DONE
...
### 1A.1.S3 - Configure pnpm workspaces - DONE
...
### 1A.1.S4 - Configure Turborepo pipeline - DONE
...
### 1A.1.S5 - Setup remote caching with Vercel - DONE
...
### 1A.1.S6 - Create workspace package templates - DONE
...
### 1A.1.S7 - Configure .gitignore for monorepo - DONE
...
### 1A.1.S8 - Update root README with architecture - DONE
...
### 1A.1.S9 - Verify Vercel deployment with monorepo - DONE
...
### 1A.2.S1 - Configure pnpm package manager - DONE

```markdown
Use the .claude/agents/tech-lead.md subagent to create the story details file for Story `S1` within Epic `1A.2`.

Refer to
- docs/4-epics/1A.2-package-management/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
### 1A.2.S2 - Set up environment validation - DONE
...
### 1A.2.S3 - Configure Husky pre-commit hooks - DONE
...
### 1A.2.S4 - Configure commitlint - DONE
...
### 1A.2.S5 - Set up markdownlint - DONE
...
### 1A.2.S6 - Configure Dependabot - DONE
...
### 1A.2.S7 - Configure CodeRabbit AI review - DONE
...
### 1A.3.S1 - Install and configure Vitest - DONE

```markdown
Use the .claude/agents/tech-lead.md subagent to create the story details file for Story `S1` within Epic `1A.3`.

Refer to
- docs/4-epics/1A.3-testing-foundation/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
### 1A.3.S2 - Configure React Testing Library - DONE
...
### 1A.3.S3 - Create mock utilities - DONE
...
### 1A.3.S4 - Install and configure Playwright - DONE
...
### 1A.3.S5 - Configure Playwright for preview deployments - DONE
...
### 1A.3.S6 - Create health endpoint smoke test - DONE
...
### 1A.3.S7 - Create @repo/testing package - DONE
...
### 1A.3.S8 - Configure MSW for API mocking - DONE
...
### 1A.3.S9 - Configure Turborepo test pipelines - DONE
...
### 1A.3.S10 - Set up CI coverage reporting - DONE
...
### 1A.4.S1 - Setup core documentation structure - DONE

```markdown
Use the .claude/agents/tech-lead.md subagent to create the story details file for Story `S1` within Epic `1A.4`.

Refer to
- docs/4-epics/1A.4-documentation-foundation/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
### 1A.4.S2 - Create ADR template and process - DONE
...
### 1A.4.S3 - Create initial ADRs from TAD - DONE
...
### 1A.4.S4 - Create root documentation files - DONE
...
### 1A.4.S5 - Evaluate and document site framework - DONE
...
### 1A.4.S6 - Create epic agent template - DONE
...
### 1A.4.S7 - Define documentation quality gates - DONE
...
### 1A.5.S1 - Configure GitHub Actions PR Workflow - DONE

```markdown
Use the .claude/agents/tech-lead.md subagent to create the story details file for Story `S1` within Epic `1A.5`.

Refer to
- docs/4-epics/1A.5-basic-cicd/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
### 1A.5.S2 - Configure GitHub Actions Main Branch Workflow - DONE
...
### 1A.5.S3 - Integrate Vercel Preview Deployments - DONE
...
### 1A.5.S4 - Configure Coverage Reporting - DONE
...
### 1A.5.S5 - Implement E2E Smoke Tests on Preview - DONE
...
### 1A.5.S6 - Configure Dependabot and Security Scanning - DONE
...
### 1A.5.S7 - Configure Branch Protection Rules - DONE
...
### 1A.5.S8 - Setup Deployment Notifications - DONE
...
### 2A.1.S1 - Create package structure and TypeScript configs - DONE

```markdown
Use the .claude/agents/tech-lead.md subagent to create the story details file for Story `S1` within Epic `2A.1`.

Refer to
- docs/4-epics/2A.1-config-package/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
### 2A.1.S2 - Configure ESLint and Prettier - DONE
...
### 2A.1.S3 - Setup Tailwind CSS v4 configuration - DONE
...
### 2A.1.S4 - Implement environment validation - DONE
...
### 2A.1.S5 - Integrate configs across existing packages - DONE
...
### 2A.1.S6 - Add tests and documentation - DONE
...
### 2A.2.S1 - Install and configure Drizzle ORM - DONE

```markdown
Use the .claude/agents/tech-lead.md subagent to create the story details file for Story `S1` within Epic `2A.2`.

Refer to
- docs/4-epics/2A.2-database-infra/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
### 2A.2.S2 - Create database connection utilities - DONE
...
### 2A.2.S3 - Set up migration infrastructure - DONE
...
### 2A.2.S4 - Create seed script framework - DONE
...
### 2A.2.S5 - Add connection pooling configuration - DONE
...
### 2A.2.S6 - Create generic helper utilities - DONE
...
### 2A.2.S7 - Write database package tests - DONE
...
### 2A.2.S8 - Document database package - DONE
...
### 2A.3.S1 - Create package structure and structured logger - DONE

```markdown
Use the .claude/agents/tech-lead.md subagent to create the story details file for Story `S1` within Epic `2A.3`.

Refer to
- docs/4-epics/2A.3-observability/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
### 2A.3.S2 - Implement Sentry error tracking integration - DONE
...
### 2A.3.S3 - Build React Error Boundary component - DONE
...
### 2A.3.S4 - Create API error handling middleware - DONE
...
### 2A.3.S5 - Implement Web Vitals tracking - DONE
...
### 2A.3.S6 - Build health check utilities - DONE
...
### 2A.3.S7 - Add monitoring dashboard integrations - DONE
...
### 2A.3.S8 - Write tests and documentation - DONE
...
### 2A.4.S1 - Create analytics package structure - DONE

```markdown
Use the .claude/agents/tech-lead.md subagent to create the story details file for Story `S1` within Epic `2A.4`.

Refer to
- docs/4-epics/2A.4-analytics-infra/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
### 2A.4.S2 - Implement core event tracking - DONE
...
### 2A.4.S3 - Add component tracking utilities - DONE
...
### 2A.4.S4 - Integrate PostHog provider - DONE
...
### 2A.4.S5 - Integrate GA4 and Vercel Analytics - DONE
...
### 2A.4.S6 - Build consent management system - DONE
...
### 2A.4.S7 - Implement feature flag utilities - DONE
...
### 2A.4.S8 - Write tests and documentation - DONE
...
## Epic 2A.5: UI Component Library

### 2A.5.S1 - Setup @repo/ui package and shadcn/ui - DONE

```markdown
Use the .claude/agents/tech-lead.md subagent to create the story details file for Story `S1` within Epic `2A.5`.

Refer to
- docs/4-epics/2A.5-ui-components/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
### 2A.5.S2 - Configure Tailwind theme tokens - DONE
...
### 2A.5.S3 - Integrate error boundary wrapper - DONE
...
### 2A.5.S4 - Integrate component analytics tracking - DONE
...
### 2A.5.S5 - Implement Button component - DONE
...
### 2A.5.S6 - Implement Input and Select components - DONE
...
### 2A.5.S7 - Implement Card, Dialog, and Dropdown Menu - DONE
...
### 2A.5.S8 - Implement Tabs, Toast, and Avatar - DONE
...
### 2A.5.S9 - Implement Badge, Skeleton, and Spinner - DONE
...
### 2A.5.S10 - Setup Storybook for component library - DONE
...
### 2A.5.S11 - Write component tests and accessibility validation - DONE
...
### 2A.5.S12 - Create package documentation - DONE
...
## Epic 2A.6: Middleware Package

### 2A.6.S1 - Create package structure and middleware composition - DONE

```markdown
Use the .claude/agents/tech-lead.md subagent to create the story details file for Story `S1` within Epic `2A.6`.

Refer to
- docs/4-epics/2A.6-middleware/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
### 2A.6.S2 - Implement request logging middleware - DONE
...
### 2A.6.S3 - Build security headers middleware - DONE
...
### 2A.6.S4 - Create rate limiting utilities - DONE
...
### 2A.6.S5 - Implement CORS configuration middleware - DONE
...
### 2A.6.S6 - Build route matcher utilities - DONE
...
### 2A.6.S7 - Add edge runtime compatibility validation - DONE
...
### 2A.6.S8 - Write tests and documentation - DONE
...
Refer to
- docs/4-epics/2A.7-auth-infra/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
Refer to
- docs/4-epics/2A.8-api-client/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
Refer to
- docs/4-epics/3A.1-cdn/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file
...
Refer to
- docs/4-epics/3A.2-routing-shell/EPIC.md for details of the epic
- Product Requirements Document and Technical Architecture Document files referenced in the EPIC.md file

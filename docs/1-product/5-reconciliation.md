...
- 2B.2 (Multi-Tenant Organization Model): M.1
...
3. **Roadmap Epics**: Defines WHEN to build it:
   ...
   - [2B.2](3-roadmap.md#epic-2b2-multi-tenant-Organization-model): Org context & switching

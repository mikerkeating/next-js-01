...
| Epic ID | Epic Name                           | PRD Features                                                                                                                                                                                                                                | TAD Sections                                                                                                                                                                                                                                           |
| ------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2B.1    | Product Database Schema             | [M.1](/docs/1-product/1-prd.md#feature-m1-multi-tenant-Organisation-management), [M.5](/docs/1-product/1-prd.md#feature-m5-content-api--data-layer)                                                                                         | [Database Schema Overview](/docs/2-technical/2-tad.md#database-schema-overview), [Database & ORM](/docs/2-technical/2-tad.md#database--orm)                                                                                                            |
| 2B.2    | Multi-Tenant Organisation Model     | [M.1](/docs/1-product/1-prd.md#feature-m1-multi-tenant-Organisation-management)                                                                                                                                                             | [Authentication & Authorization](/docs/2-technical/2-tad.md#authentication--authorization), [Database Schema Overview](/docs/2-technical/2-tad.md#database-schema-overview), [Security Architecture](/docs/2-technical/2-tad.md#security-architecture) |
...
- 2B.6 (Product Middleware): _(No direct feature mapping - infrastructure)_
...
- 3B.8 (Reporting & Automation): C.3 _(Deferred)_
- 3B.9 (Webhooks & Integrations): C.5 _(Deferred)_
...
- **M.1** (Multi-Tenant Organisation Management): 3 epics → Foundational feature requiring DB, org model, and auth
- **M.3** (Organisation-Specific Content Views): 3 epics → Cross-cutting feature spanning UI, routing, and docs
...
### Traceability Example: M.1 Multi-Tenant Organisation Management

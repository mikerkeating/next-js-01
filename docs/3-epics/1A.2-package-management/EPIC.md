...
| S6 | [Configure Markdown Linting](./S6-markdown-lint.md) | S | ⬜ | S4, S5 | S8 |
...
| Markdown link validation | markdownlint-cli2 vs remark-lint | Affects dead link detection capability | ⬜ Open |
...
**Note**: S-sized stories estimated at ~2.5h average for configuration tasks. M-sized stories (Environment Validation, lint-staged) require more testing to ensure IDE and CI compatibility.
